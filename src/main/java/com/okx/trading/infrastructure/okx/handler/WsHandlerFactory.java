...
import com.okx.trading.infrastructure.okx.entity.ws.biz.*;
import com.okx.trading.infrastructure.okx.entity.ws.pri.*;
import com.okx.trading.infrastructure.okx.entity.ws.pub.*;
import com.okx.trading.infrastructure.okx.entity.ws.response.Event;
import com.okx.trading.infrastructure.okx.entity.ws.response.biz.*;
import com.okx.trading.infrastructure.okx.entity.ws.response.pri.*;
import com.okx.trading.infrastructure.okx.entity.ws.response.pub.*;
...
import static com.okx.trading.infrastructure.okx.constant.OkxConstants.*;
    ...
    private static WsHandler getSubscribeHandler(
        ...
        return switch (channel) {
            ...
            case ACCOUNT -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pri.AccountArg.class,
            ...
            case POSITIONS -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pri.PositionsArg.class,
                            channel, message, wsChannel);
            case BALANCE_AND_POSITION -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pri.BalanceAndPositionArg.class,
                            channel, message, wsChannel);
            case LIQUIDATION_WARNING -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pub.LiquidationOrdersArg.class,
                            channel, message, wsChannel);
            case ACCOUNT_GREEKS -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pri.AccountGreeksArg.class,
                            channel, message, wsChannel);
            case ORDERS -> pushData ?
                    new WsSubscribePushHandler<>(OrderArg.class, Order.class, channel, message, wsChannel) :
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pri.OrderArg.class,
                            channel, message, wsChannel);
            // public
            case INSTRUMENTS -> pushData ?
                    new WsSubscribePushHandler<>(InstrumentsArg.class, Instruments.class, channel, message, wsChannel) :
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pub.InstrumentsArg.class,
                            channel, message, wsChannel);
            case OPEN_INTEREST -> pushData ?
                    new WsSubscribePushHandler<>(OpenInterestArg.class, OpenInterest.class, channel, message, wsChannel) :
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pub.OpenInterestArg.class,
                            channel, message, wsChannel);
            case FUNDING_RATE -> pushData ?
                    new WsSubscribePushHandler<>(FundingRateArg.class, FundingRate.class, channel, message, wsChannel) :
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pub.FundingRateArg.class,
                            channel, message, wsChannel);
            case PRICE_LIMIT -> pushData ?
                    new WsSubscribePushHandler<>(PriceLimitArg.class, PriceLimit.class, channel, message, wsChannel) :
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pub.PriceLimitArg.class,
                            channel, message, wsChannel);
            case OPT_SUMMARY -> pushData ?
                    new WsSubscribePushHandler<>(OptionSummaryArg.class, OptionSummary.class, channel, message, wsChannel) :
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pub.OptionSummaryArg.class,
                            channel, message, wsChannel);
            case ESTIMATED_PRICE -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pub.EstimatedPriceArg.class,
                            channel, message, wsChannel);
            case MARK_PRICE -> pushData ?
                    new WsSubscribePushHandler<>(MarkPriceArg.class, MarkPrice.class, channel, message, wsChannel) :
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pub.MarkPriceArg.class,
                            channel, message, wsChannel);
            case INDEX_TICKERS -> pushData ?
                    new WsSubscribePushHandler<>(IndexTickersArg.class, IndexTickers.class, channel, message, wsChannel) :
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pub.IndexTickersArg.class,
                            channel, message, wsChannel);
            ...
            case ADL_WARNINGS -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.pub.AdlWarningArg.class,
                            channel, message, wsChannel);
            // business
            case DEPOSIT_INFO -> pushData ?
                    new WsSubscribePushHandler<>(DepositInfoArg.class, DepositInfo.class, channel, message, wsChannel) :
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.biz.DepositInfoArg.class,
                            channel, message, wsChannel);
            case WITHDRAWAL_INFO -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.biz.WithdrawalInfoArg.class,
                            channel, message, wsChannel);
            case MARK_PRICE_CANDLE_3MON,
                 ...
                 MARK_PRICE_CANDLE_6H_UTC -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.biz.MarkPriceCandlesticksArg.class,
                            channel, message, wsChannel);
            case INDEX_CANDLE_3MON,
                 ...
                 INDEX_CANDLE_6H_UTC -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.biz.IndexCandlesticksArg.class,
                            channel, message, wsChannel);
            case ECONOMIC_CALENDAR -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.biz.EconomicCalendarArg.class,
                            channel, message, wsChannel);
            case ALGO_ORDERS -> pushData ?
                    new WsSubscribePushHandler<>(AlgoOrderArg.class, AlgoOrder.class, channel, message, wsChannel) :
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.biz.AlgoOrderArg.class,
                            channel, message, wsChannel);
            case ADVANCE_ALGO_ORDERS -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.biz.AdvanceAlgoOrderArg.class,
                            channel, message, wsChannel);
            case GRID_ORDERS_SPOT -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.biz.GridOrderSpotArg.class,
                            channel, message, wsChannel);
            case GRID_ORDERS_CONTRACT -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.biz.GridOrderContractArg.class,
                            channel, message, wsChannel);
            case GRID_POSITIONS -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.biz.GridPositionsArg.class,
                            channel, message, wsChannel);
            case GRID_SUB_ORDERS -> pushData ?
                    ...
                    new WsSubscribeHandler<>(com.okx.trading.infrastructure.okx.entity.ws.request.biz.GridSubOrderArg.class,
                            channel, message, wsChannel);
        };
    }

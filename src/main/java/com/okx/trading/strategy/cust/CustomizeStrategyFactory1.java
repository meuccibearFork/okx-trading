...
//            log.info("[数据]Current Bar: isNewBar:{} endIndex:{} currentBar:{} previousBar:{} candlestick:{}", isNewBar, endIndex, currentBar, previousBar, candlestick);
//
//
//            if (isNewBar) {
//                // 计算信号
...
//        log.info("[操作][开多仓] 入场价: {}, 止损价: {}, 时间: {} symbol:{}", entryPrice, stopLoss, currentBar.getEndTime(), state.getSymbolSwap());
...
//        log.info("[操作][开空仓] 入场价: {}, 止损价: {}, 时间: {} symbol:{}",
...
//        log.info("[操作][移动止盈激活] 当前价格: {}, 持仓类型: {}", currentBar.getClosePrice(), currentPosition.getType());
...
//
//        log.info("[操作][平仓] 原因: {}, 入场价: {}, 止损价: {}, 出场价: {}, 盈亏: {}, 持仓时间: {}",
